...
# June 1, 2022 - Yellow 4h evening experiment adapated from the melanopsin protocol by CPT
...
#mel_up = [0, 392, 0, 0, 137, 570, 0]
#mel_down = [123, 0, 557, 0, 0, 0, 3306]

# yellow component values from yellow steady 12h lighting
yellow =  [0, 0, 450, 400, 900, 450, 135] 
...
while abort == False:
    ...
    if (hourStart <= currentTime) and (currentTime < hourStopWhite):
        ...
        if (currentTime < hourStopMela):
              currentTime = datetime.datetime.now().hour
              set_spectrum_a(yellow, cj)
              #time.sleep(30)
